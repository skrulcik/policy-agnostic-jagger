...
import com.scottkrulcik.agnostic.annotations.FacetMe;
...
public class FacetProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> set, RoundEnvironment roundEnvironment) {
        for(Element element : roundEnvironment.getElementsAnnotatedWith(FacetMe.class)) {
    ...
    @Override public Set<String> getSupportedAnnotationTypes() {
        return Collections.singleton(FacetMe.class.getCanonicalName());
    }
